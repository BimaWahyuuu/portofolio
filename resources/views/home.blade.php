...
@section('content')
        ...
        <section class="jumbotron text-center">
            <img src="{{ asset('img/b1.jpeg') }}" alt="aaa" width="200" class="gambar rounded-circle img-thumbnail">
            <h1 class="display-4">Bima Wahyu Luckyta</h1>
            <p class="lead">11 RPL 1 | Absen 18</p>
        </section>
